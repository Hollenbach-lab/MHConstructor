...
ftp=$(less ${2} | grep ${1} )  
echo $ftp
mkdir ${5}/extractedReads
${progSamtools} view -f 1 -h -T ../refMHC/GRCh38_full_analysis_set_plus_decoy_hla.fa -b ${ftp} ${3}| ${progSamtools} sort - -n -o ${5}/extractedReads/${1}_mhc_paired.sorted.bam
...
do
	...
	echo ${altLoc}
	${progSamtools} view -f 1 -h -T ../refMHC/GRCh38_full_analysis_set_plus_decoy_hla.fa -b ${ftp} ${altLoc} | ${progSamtools} sort - -n -o ${5}/extractedReads/${1}_mhc_${altLoc}_paired.sorted.bam
...
${progSamtools} view -h -T ../refMHC/GRCh38_full_analysis_set_plus_decoy_hla.fa -b ${ftp} '*' | ${progSamtools} sort - -n -o ${5}/extractedReads/${1}_unmap.sorted.bam
