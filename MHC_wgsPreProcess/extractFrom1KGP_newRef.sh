...
ftp=$(less ${2} | grep ${1} )  
echo $ftp
${progSamtools} view -f 1 -h -T ../refMHChaps/GRCh38_full_analysis_set_plus_decoy_hla.fa  -b ${ftp} chr6:28509120-33481577 | ${progSamtools} sort - -n -o ${5}/${1}_mhc_paired.sorted.bam 
